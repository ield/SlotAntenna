...
%  	FUNCI?N QUE CALCULA EL CAMPO RADIADO POR UN AGRUPAMIENTO 
% 	PLANO DE RANURAS DE IGUAL ANCHURA PARA UN DETERMINADO N?MERO 
% 	DE DIRECCIONES (theta,phi).

%  	COMO RESULTADO SE OBTIENEN LOS M?DULOS AL CUADRADO DEL
% 	M?XIMO VALOR DE CAMPO Y DE LAS COMPONENTES 
...
%	DIMENSIONES: nran*nth
   ...
   % Hay un problema de indeterminaci?n con 0/0
   for n=1:nran,
       for m=1:nth,
           if (1-4*u(n,m)^2)==0,
               pattel(n,m)=pi/4;
