...
function [Dmax,Dmin,angPencil]=MaskPencil(resTheta,resPhi)
...
bw=10; %Main beam width (at -3 dB) (degrees)
angPencil=bw/2; %half of the width of the main beam (degrees)
angSec=40; %Angle that determines the end of the sidelobes
Gmax=26; %Gain (dBi)
Gmin=5; %Difference between the maximum and minimum gain in the main beam (dB)
LobSec=16; %Desired sidelobe level (dB)
